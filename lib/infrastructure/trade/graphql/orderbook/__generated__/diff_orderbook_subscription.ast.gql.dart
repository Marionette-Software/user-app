...
const PublicDiffOrderBookSubscription = _i1.OperationDefinitionNode(
  type: _i1.OperationType.subscription,
  name: _i1.NameNode(value: 'PublicDiffOrderBookSubscription'),
  variableDefinitions: [
...
const document =
    _i1.DocumentNode(definitions: [PublicDiffOrderBookSubscription]);
