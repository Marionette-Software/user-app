...
class MarketLimitSwitchWeb extends StatefulHookConsumerWidget {
  final Function(int page)? changeType;
  final List<OrderType> options;

  const MarketLimitSwitchWeb({
    Key? key,
    this.changeType,
  ...
  @override
  ConsumerState<MarketLimitSwitchWeb> createState() =>
      _MarketLimitSwitchWebState();
}

class _MarketLimitSwitchWebState extends ConsumerState<MarketLimitSwitchWeb> {
