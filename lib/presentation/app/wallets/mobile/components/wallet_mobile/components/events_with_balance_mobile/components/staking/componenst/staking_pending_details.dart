...
class StakingPendingDetailsMobile extends StatefulHookConsumerWidget {
  const StakingPendingDetailsMobile({
  ...
  @override
  ConsumerState<StakingPendingDetailsMobile> createState() =>
      _StakingPendingDetailsMobileState();
}

class _StakingPendingDetailsMobileState
    extends ConsumerState<StakingPendingDetailsMobile> {
  String timerValue = '--:--';
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '${numberFormatWithPrecision(walletData.precision).format(stakingCurrencyWatch.locked_balance)} ${walletData.id.toUpperCase()}',
              style: Theme.of(context).textTheme.titleSmall!.copyWith(
                    fontSize: 15.sp,
                    fontWeight: FontWeight.w500,
                    letterSpacing: -0.75.sp,
