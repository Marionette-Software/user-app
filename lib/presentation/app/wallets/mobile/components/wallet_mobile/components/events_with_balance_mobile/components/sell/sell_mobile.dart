...
class SellMobile extends StatefulHookConsumerWidget {
  const SellMobile({
    super.key,
  });

  @override
  ConsumerState<SellMobile> createState() => _SellMobileState();
}

class _SellMobileState extends ConsumerState<SellMobile> {
  @override
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'Sell ${walletData.id.toUpperCase()}',
