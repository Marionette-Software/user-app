...
class StakingNextRewardDetailsWeb extends StatefulHookConsumerWidget {
  const StakingNextRewardDetailsWeb({
  ...
  @override
  ConsumerState<StakingNextRewardDetailsWeb> createState() =>
      _StakingNextRewardDetailsWebState();
}

class _StakingNextRewardDetailsWebState
    extends ConsumerState<StakingNextRewardDetailsWeb> {
  String timerValue = '--:--';
